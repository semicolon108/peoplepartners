...
export const contactDetails: ContactDetail[] =[
    {
        ...
        title: "Email Us",
        lines: [
            { text: "info@peoplepartnerslaos.com", href: "mailto:info@peoplepartnerslaos.com" },
    ...
    },
    {
        ...
        title: "Call Us",
        lines: [
            { text: "+856 20 9968 6599", href: "tel:+8562099686599" },
            { text: "Mon - Fri: 9:00 AM - 5:00 PM (GMT+7)" }
        ]
    },
    {
        icon: <MapPin />,
