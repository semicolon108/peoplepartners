            ...
            <main>
                <section className="py-20 bg-white">
                    <div className="container">
                        <h2 className="text-3xl font-bold text-center mb-12 text-brand-blue-dark">Why Choose Our Recruitment Services?</h2>
                ...
                <section className="py-20 bg-brand-gray-light">
                    <div className="container">
                        <h2 className="text-3xl font-bold text-center mb-12 text-brand-blue-dark">Our Proven Recruitment Process</h2>
