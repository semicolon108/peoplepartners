            ...
            <main>
                <section className="py-20 bg-white">
                    <div className="container">
                        <h2 className="text-3xl font-bold text-center mb-12 text-brand-blue-900">Transform Your Business Operations</h2>
                        <FeaturesGrid features={serviceData.features} />
                    </div>
                </section>
                <section className="py-20 bg-brand-gray-50">
                    <div className="container">
                        <h2 className="text-3xl font-bold text-center mb-12 text-brand-blue-900">Our BPO Service Categories</h2>
                ...
                <section className="py-20 bg-white">
                    <div className="container">
                        <h2 className="text-3xl font-bold text-center mb-12 text-brand-blue-900">Our BPO Implementation Process</h2>
